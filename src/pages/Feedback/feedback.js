...
//   const consentRedux = useSelector((stateRedux) => stateRedux.userData.consent);
  ...
  const [feedbackData, setFeedbackData] = useState({
    repository: 'drone-image-manipulation',
    title: '',
    comments: '',
    labels: [],
    // screenshot: null,
...
//   }, [consentRedux]);
  ...
  const handleSubmit = () => {
    fetch('https://developfeedback.covercrop-data.org/v1/issues', {
      ...
      body: JSON.stringify({ ...feedbackData, labels: ['app2', ...feedbackData.labels] }),
    })
      .then((response) => {
    ...
    >
      ...
      <Grid container item spacing={1} justifyContent="flex-start" alignItems="flex-start">
        ...
        <Grid item xs={12}>
          <Typography variant="body1">
            ...
            {/* You can attach a screenshot of your feedback below. */}
          </Typography>
        </Grid>
        <Grid item xs={12}>
          <TextField
      ...
      <Grid container item spacing={1} justifyContent="flex-start" alignItems="flex-start">
        ...
        <Grid item xs={12}>
          <FormGroup>
            <FormControlLabel
              control={<Checkbox onChange={handleCheckboxChange} name="About the Data Presented" />}
              label="About the Data Presented"
            />
            <FormControlLabel
